...
template <typename T>
typename PointMatcher<T>::DataPoints rosMsgToPointMatcherCloud(const sensor_msgs::LaserScan &rosMsg, const bool addTimestamps)
{
  typedef PointMatcher<T> PM;
  typedef typename PM::DataPoints DataPoints;
  //  typedef typename DataPoints::Label Label;
...
template PointMatcher<float>::DataPoints rosMsgToPointMatcherCloud<float>(const sensor_msgs::LaserScan &rosMsg, const bool addTimestamps);
template PointMatcher<double>::DataPoints rosMsgToPointMatcherCloud<double>(const sensor_msgs::LaserScan &rosMsg, const bool addTimestamps);
